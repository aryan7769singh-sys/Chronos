...
import { TodaysPlanWidget } from "@/features/dashboard/components/TodaysPlanWidget";
...
export default async function DashboardPage() {
  ...
  const [habits, todaysTasks, upcomingDeadlines, focusTask, focusSummary, recentNotes, todaysBlocks] =
    session?.user?.id
      ? await Promise.all([
          ...
          getTodaysTimeBlocks(session.user.id),
        ])
      : [
          [],
          [],
    ...
    <div className="p-4 md:p-6 space-y-4 md:space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-4 md:gap-6 items-start">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          {/* Today's Plan — time-blocked work for the day */}
          <TodaysPlanWidget blocks={todaysBlocks} />
